  ...
  function Filters(props) {
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("input", { type: "text", name: "person_name",
      ...
      React.createElement(
        ...
        React.createElement(
          "label",
          null,
          React.createElement("input", { type: "checkbox", checked: props.isIntern, onChange: updateIntern, name: "person_intern" }),
          " Intern"
        )
      ),
      React.createElement(
